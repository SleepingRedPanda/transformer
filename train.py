...
def run_validation(model, validation_ds, tokenizer_src, tokenizer_trg, max_len, device, print_msg, global_step, writer, num_exampes=2):
    model.eval()
    count = 0
